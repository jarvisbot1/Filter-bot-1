...
URL = "https://jarvis-bot-nmjc.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jarvis-bot-nmjc.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jarvis-bot-nmjc.onrender.com/".format(FQDN)
else:
    URL = "https://jarvis-bot-nmjc.onrender.com/".format(FQDN)
