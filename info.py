...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1743117471').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002083059432').split()]
...
URL = "https://jarvis-bot-loyj.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://jarvis-bot-loyj.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://jarvis-bot-loyj.onrender.com/".format(FQDN)
else:
    URL = "https://jarvis-bot-loyj.onrender.com/".format(FQDN)
